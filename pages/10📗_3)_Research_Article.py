...
st.markdown("[Reading01-chapter](https://github.com/MK316/Engedu-phonology/blob/main/pages/lecture/DW2018.pdf)")

# ------------ CONFIG ------------
GITHUB_OWNER  = "MK316"
GITHUB_REPO   = "Engedu-phonology"
GITHUB_BRANCH = "main"

# Folder where the DW.001.png files are stored
FOLDER_PATH   = "pages/lecture/DW"

# Update to match your file pattern
FILENAME_PREFIX = "DW."
FILENAME_EXT    = ".png"

# Update index range (1 → 15)
START_INDEX     = 1
END_INDEX       = 15
